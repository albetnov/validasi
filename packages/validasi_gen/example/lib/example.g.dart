...
class UserConfirmEmailField extends UserFields<String> {
  ...
  @override String get name => 'confirmEmail';

  @override String extract(User owner) => owner.confirmEmail;
  ...
  List<ValidationError> Function(
    ...
    return (getField) {
      ...
      if (result != null) {
        return [ValidationError(rule: 'ValidateWith', message: result, path: ['confirmEmail'])];
      }
      return [];
    };
  }
...
User assemble_User(
    ...
    confirmEmail: ctrl.getValue(UserFields.confirmEmail) as String,
...
extension $UserValidasi on User {
  ValidasiResult<User> validate() {
    ...
    dynamic? getField<V>(ValidasiField<User, V> field) => field.extract(this);
    {
