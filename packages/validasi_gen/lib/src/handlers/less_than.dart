...
class LessThanGen extends RuleGen {
  @override
  ...
  String defaultMessage(RuleInfo info,
      ...
      'Value must be less than ${info.params['max']}';

  @override
  String emitError(RuleInfo info, String pathExpr, String messageArg,
          [FieldContext context = FieldContext.generic]) =>
      '_Errors.lessThan($pathExpr, ${info.params['max']}$messageArg)';

  @override
  Map<String, String> get helperMethods => {
        'lessThan':
            "static ValidationError lessThan(List<String> path, num max, {String? message}) =>\n"
                '      ValidationError(\n'
                "        rule: 'LessThan',\n"
