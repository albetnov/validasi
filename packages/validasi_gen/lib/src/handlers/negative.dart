...
class NegativeGen extends RuleGen {
  @override
  String get name => 'Negative';
  ...
  RuleInfo parse(ConstantReader rule) {
    return RuleInfo('Negative', const {}, rule.peek('message')?.stringValue);
  }
  ...
  String emitError(RuleInfo info, String pathExpr, String messageArg,
          [FieldContext context = FieldContext.generic]) =>
      '_Errors.negative($pathExpr$messageArg)';

  @override
  Map<String, String> get helperMethods => {
        'negative':
            "static ValidationError negative(List<String> path, {String? message}) =>\n"
                '      ValidationError(\n'
                "        rule: 'Negative',\n"
