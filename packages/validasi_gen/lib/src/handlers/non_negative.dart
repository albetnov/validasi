...
class NonNegativeGen extends RuleGen {
  @override
  String get name => 'NonNegative';
  ...
  String emitError(RuleInfo info, String pathExpr, String messageArg,
          [FieldContext context = FieldContext.generic]) =>
      '_Errors.nonNegative($pathExpr$messageArg)';

  @override
  Map<String, String> get helperMethods => {
        'nonNegative':
            "static ValidationError nonNegative(List<String> path, {String? message}) =>\n"
                '      ValidationError(\n'
                "        rule: 'NonNegative',\n"
